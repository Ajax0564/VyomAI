...
|[**`casual language-modeling fused`**](https://github.com/Ajax0564/VyomAI/blob/main/Examples/vyom-ai-decode-fused.ipynb) | [mark-twain-books](https://www.kaggle.com/datasets/msinger007/mark-twain-books) |✅|fused decoder model and kv-cache for fast inference and training, we achieve a 1.3x reduction in peak memory usage and 1.4x training speed compared to native PyTorch.  | 
