...
|[**`Native Encoder text classification`**](https://github.com/Ajax0564/VyomAI/blob/main/Examples/vyom-ai-encoder-no-padding.ipynb) | [clinc_oos](https://www.kaggle.com/code/ajax0564/data-for-distilation) |✅|Encoder model that process input at its native length without padding it can be employed by any type of encoder model|
...
|[**`casual language-modeling fused`**](https://github.com/Ajax0564/VyomAI/blob/main/Examples/vyom-ai-decoder-fused.ipynb) | [mark-twain-books](https://www.kaggle.com/datasets/msinger007/mark-twain-books) |✅|fused decoder model and kv-cache for fast inference and training, we achieve a 1.3x reduction in peak memory usage and 1.4x training speed compared to native PyTorch.  | 
...
|[**`Native vit`**](https://github.com/Ajax0564/VyomAI/blob/main/Examples/vyom-ai-native-vit.ipynb) | [Scene-classification](https://www.kaggle.com/datasets/nitishabharathi/scene-classification) |✅|visual image transformer for Native image classification utilizes Var len attention kernel|
