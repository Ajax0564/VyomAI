...
|[**`vision language multimodel-I`**](https://github.com/Ajax0564/VyomAI/tree/main/Examples/Multimodel_basic.ipynb) | [COCO](https://www.kaggle.com/datasets/nikhil7280/coco-image-caption) |✅|A minimmal vision-language model implementation with image-text fusion  to generate image caption with RoPE and kv-cache|
