...
|[**`vision language multimodel-II`**](https://github.com/Ajax0564/VyomAI/blob/main/Examples/vyom-ai-multimodel-advance.ipynb) |[COCO](https://www.kaggle.com/datasets/nikhil7280/coco-image-caption) |✅|A Multimodel implementation with image-text fusion  to generate caption of  image  with RoPE and kv-cache  which can we extended to VQA, OCR etc|
